-- =================================================================
-- Migration: Extend p_search to also match creator_name and creator_id
-- Purpose: The FilterBar placeholder is "Tìm theo creator hoặc tiêu đề video..."
--          but the RPCs only matched v.video_title. Typing a KOC id like
--          "thyneeee_" therefore returned no rows. Update both RPCs so
--          p_search scans creator fields as well.
-- Signature is unchanged; CREATE OR REPLACE replaces the body in place.
-- =================================================================
