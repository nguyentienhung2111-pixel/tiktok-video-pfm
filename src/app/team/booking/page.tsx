    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="p-12 space-y-8">
        <div className="grid grid-cols-3 gap-5">
           <Scorecard label="Video KOC" value={videos.length} />
           <Scorecard label="Tổng GMV KOC" value={new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(videos.reduce((s,v)=>s+v.gmv, 0))} />
        </div>
